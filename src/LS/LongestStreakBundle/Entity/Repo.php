 ...
 * @ORM\Entity(repositoryClass="\LS\LongestStreakBundle\Repository\RepoRepository")
 */
...
class Repo
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="LS\LongestStreakBundle\Entity\Commit", mappedBy="repo")
     */
    private $commits;

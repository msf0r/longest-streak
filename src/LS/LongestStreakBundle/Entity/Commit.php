 ...
 * @ORM\Entity(repositoryClass="\LS\LongestStreakBundle\Repository\CommitRepository")
 */
class Commit
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="LS\LongestStreakBundle\Entity\Repo", inversedBy="commits")

...
//use LongestStreak\LongestStreakBundle\Manager\UserManager;
...
//                ]
//        ];
//        $githubProviderMock = $this->getMock('\LongestStreak\LongestStreakBundle\Provider\GitHubProvider', ['getUserRepos'], [], '', false);
//        $githubProviderMock
//            ->expects($this->any())
//            ->method('getUserRepos')
...
//    {
//        $githubProviderMock = $this->getMock('\LongestStreak\LongestStreakBundle\Provider\GitHubProvider', ['getUserCommitsFromRepo'], [], '', false);
//        $githubProviderMock
//            ->expects($this->any())

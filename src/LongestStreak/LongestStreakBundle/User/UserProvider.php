...
namespace LongestStreak\LongestStreakBundle\User;
...
class UserProvider implements OAuthAwareUserProviderInterface, UserProviderInterface
{
    ...
    {
        $user = $this->em->getRepository('LongestStreakLongestStreakBundle:User')->findOneBy(['login'=>$response->getNickname()]);
    ...
    public function refreshUser(UserInterface $user)
    {
        ...
        return $this->em->getRepository('LongestStreakLongestStreakBundle:User')->find($user->getId());
    }

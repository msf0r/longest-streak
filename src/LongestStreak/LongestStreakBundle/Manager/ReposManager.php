...
class ReposManager //RepositoryUpdater
{
    ...
    public function updateRepos($login)
    {
        ...
        /** @var User $user */
        $user = $this->em->getRepository('LongestStreakLongestStreakBundle:User')->findOneBy(['login' => $login]);
        ...
        $reposArray = $this->em->getRepository('LongestStreakLongestStreakBundle:Repo')->findBy(['gitLogin' => $user->getLogin()]);

 ...
 * @ORM\Entity(repositoryClass="LongestStreak\LongestStreakBundle\Repository\UserRepository")
 */
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="LongestStreak\LongestStreakBundle\Entity\Streak", inversedBy="user", cascade={"persist"})
